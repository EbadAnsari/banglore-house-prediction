...
function onClickedEstimatePrice() {
	...
	let url = "http://127.0.0.1:5000/api/predict_home_price"; // Use this if  you are using nginx. i.e tutorial 8 and onwards
...
function onPageLoad() {
	...
	let url = "http://127.0.0.1:5000/api/get_location_names"; // Use this if  you are using nginx. i.e tutorial 8 and onwards
